...
import { Calendar, Dumbbell, Clock, Activity, User, ChevronRight, TrendingUp, Target, Flame, Plus } from 'lucide-react';
  ...
  const renderExerciseIcon = (exercise: DateWorkout['exercises'][0]) => {
    ...
    return (
      <>
        {isCardio ? (
          <>
            <Clock size={20} className="text-primary sm:hidden" />
            <Clock size={24} className="text-primary hidden sm:block" />
          </>
        ) : (
          <>
            <Dumbbell size={20} className="text-primary sm:hidden" />
            <Dumbbell size={24} className="text-primary hidden sm:block" />
          </>
        )}
      </>
    );
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-6">
            <div className="lg:col-span-8 space-y-4 sm:space-y-6">
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4">
                <div className="bg-dark-light rounded-xl sm:rounded-2xl p-3 sm:p-4 border border-white/5 hover:border-primary/20 transition-colors">
                ...
                <div className="bg-dark-light rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-white/5">
                  ...
                  <div className="space-y-3 sm:space-y-4">
                    {todayWorkout.exercises.map((exercise, index) => (
                      <div key={index} className="bg-dark rounded-lg sm:rounded-xl p-3 sm:p-4 border border-white/5 hover:border-primary/20 transition-colors">
              ...
              <div className="bg-dark-light rounded-xl sm:rounded-2xl border border-white/5">
                <div className="flex items-center justify-between p-4 sm:p-6 border-b border-white/5">
                  ...
                  <Link 
                    to="/create-plan" 
                    className="bg-instagram-gradient text-light px-2 py-1.5 rounded-xl text-xs font-medium flex items-center sm:hidden"
                  >
